...
public class MaxAndMinOfThreeNos {
    public static void main(String[] args) {
        ...
        System.out.print("Entter Third Number: ");
        double third_no = input.nextDouble();
        double maxinum_of_three_nos = largest(first_no, second_no, third_no);
        double minimum_of_three_nos = smallest(first_no, second_no, third_no);
        System.out.println("Maximum Number from " + first_no + ", " + second_no + ", " + third_no + " = " + maxinum_of_three_nos);
