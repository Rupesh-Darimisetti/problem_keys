...
public class _9_ArmstrongNumber {
    ...
    /**
     * @param num
     *         check the number is armstrong or not. split the number into individual no. multiply the same number
     *         thrice to itself add all the multiplied individual numbers
     *
