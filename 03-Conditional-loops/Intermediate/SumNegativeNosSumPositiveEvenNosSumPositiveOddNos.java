...
public class SumNegativeNosSumPositiveEvenNosSumPositiveOddNos {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        System.out.print("Enter a set of Nos to print the sum of negative numbers, sum of positive even numbers\n" +
                "and the sum of positive odd numbers from a list of numbers (N) entered by the user.\n" +
                "The list terminates when the user enters a zero.");
