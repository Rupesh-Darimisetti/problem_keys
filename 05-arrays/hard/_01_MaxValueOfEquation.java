...
public class _01_MaxValueOfEquation {
    public static void main(String[] args) {
        int[][] points = {{1, 3}, {2, 0}, {5, 10}, {6, -10}};
        int k = 1;
        int maxVal = findMaxValueOfEquation(points, k);
    ...
    private static int findMaxValueOfEquation(int[][] points, int k) {
        ...
        for (int i = 0; i < points.length; i++) {
            ...
            // and x in peeked index is greater than k then we don't need the peeked value in deque
